...
<head>
    ...
    <title>Erciyes Teknopark KİOSK V1.5</title>
                                ...
                                <div class="swiper-container">
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide" data-swiper-autoplay="20000">
                                            <img src="upload/7_16_06_52_17_35_15.jpg" class="img-fluid">
                                        </div>
                                        ...
                                        <div class="swiper-slide" data-swiper-autoplay="20000">
                                            <img src="upload//bigg-erciyes-2021-copy1-copy22_14_59_44_17_39_09.jpg"
                                                class="img-fluid">
                                        </div>
                                        ...
                                        <div class="swiper-slide" data-swiper-autoplay="20000">
                                            <img src="upload/8_16_07_15_09_32_33.jpg" class="img-fluid">
                                        </div>
                                        ...
                                        <div class="swiper-slide" data-swiper-autoplay="20000">
                                            <img src="upload/1_09_55_52_17_40_50.jpg" class="img-fluid">
                                        </div>
                                        ...
                                        <div class="swiper-slide" data-swiper-autoplay="20000">
                                            <img src="upload/5_16_06_26_17_42_43.jpg" class="img-fluid">
                                        </div>
                                        ...
                                        <div class="swiper-slide" data-swiper-autoplay="20000">
                                            <img src="upload/4_16_04_58_17_43_14.jpg" class="img-fluid">
                                        </div>
                                        ...
                                        <div class="swiper-slide" data-swiper-autoplay="20000">
                                            <img src="upload/dijital-ekran_17_05_04.jpg" class="img-fluid">
                                        </div>
                                        ...
                                        <div class="swiper-slide" data-swiper-autoplay="30000">
                                            <img src="upload/bigg-erciyes-yesil-buyume-2-1_09_34_35.jpg"
                                                class="img-fluid">
                                        </div>
                                        ...
                                        <div class="swiper-slide" data-swiper-autoplay="20000">
                                            <img src="upload/afis_benim-isim-girisim_11_33_22.jpg" class="img-fluid">
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-lg-3">
                                        <div class="dollar">
                                            ...
                                            <br>
                                            <span id="jsonDollarData"> 13.57 </span> <span>TL</span>
                                            <br>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-lg-3">
                                        <div class="dollar">
                                            ...
                                            <br>
                                            <!-- ₺ -->
                                            <span id="jsonEuroData"> 15.56 </span><span> TL</span>
                                            <br>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-lg-3">
                                        <div class="dollar">
                                            ...
                                            <br>
                                            <span id="jsonAltinData"> 788.57 </span> <span>TL</span>
                                            <br>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-lg-3">
                                        <div class="dollar">
                                            <i class="fa fa-sun-o" aria-hidden="true"> </i>
                                            <br>
                                            <span id="jsonCeyrekAltinData"> 1.280.00</span> <span> TL</span><br> <strong
                                                style="color: white; "> Çeyrek altın </strong>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8 col-lg-8">
                                                        <div class="weather-panel-top">
                                                            ...
                                                            <p class="h3"><i class="mi mi-fw mi-lg mi-rain-heavy"></i>
                                                                hafif kar yağışlı</p>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <ul class="list-inline row forecast">
                                                            <li class="col-xs-4 col-sm-2 text-center">
                                                                <h3 class="h5">Pzt</h3>
                                                                <p><i class="mi mi-fw mi-2x mi-cloud-sun"></i><br>9°/18°
                                                                </p>
                                                            </li>
                                                            <li class="col-xs-4 col-sm-2 text-center">
                                                                <h3 class="h5">Salı</h3>
                                                            ...
                                                            <li class="col-xs-4 col-sm-2 text-center">
                                                                <h3 class="h5">Çar</h3>
                                                                <p><i
                                                                        class="mi mi-fw mi-2x mi-cloud-sun"></i><br>14°/24°
                                                                </p>
                                                            </li>
                                                            <li class="col-xs-4 col-sm-2 text-center">
                                                                <h3 class="h5">Per</h3>
                                                            ...
                                                            <li class="col-xs-4 col-sm-2 text-center">
                                                                <h3 class="h5">Cum</h3>
                                                                <p><i
                                                                        class="mi mi-fw mi-2x mi-rain-heavy"></i><br>15°/22°
                                                                </p>
                                                            </li>
                                                            <li class="col-xs-4 col-sm-2 text-center">
                                                                <h3 class="h5">Cmt</h3>
                                                                <p><i class="mi mi-fw mi-2x mi-clouds"></i><br>12°/17°
                                                                </p>
                                                            </li>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-8 col-md-8 ">
                                                        <div class="details">
                                                            ...
                                                            <div class="summary">
                                                                <p class="summaryText">Orta şiddetli yağmur </p>
                                                            </div>
                                                            <div class="precipitation">Gece Sıcaklığı: 4° </div>
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="alert alert-warning text-center text-black"
                                            ...
                                            TÜRKİYE COVID-19 HASTA TABLOSU</div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="card">
                                            <div class=" btn btn-primary">
                                                <h2 class="fw-light text-white">8.700.641</h2>
                                                <h6 class="text-white Confirmed">Toplam Vaka Sayısı</h6>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class=" col-sm-6 col-md-6">
                                        <div class="card">
                                            <div class="btn btn-danger">
                                                <h2 class="fw-light text-white">76.724</h2>
                                                <h6 class="text-white Deaths">Toplam Vefat Sayısı</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="card">
                                            <div class="btn btn-success">
                                                <h2 class="fw-light text-black"> 205.250 </h2>
                                                <h6 class="text-black Recovered">Toplam iyileşen Sayısı</h6>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class=" col-sm-6 col-md-6">
                                        <div class="card">
                                            <div class=" btn btn-warning">
                                                <h2 class="fw-light text-black">173.957</h2>
                                                <h6 class="text-black Active">Aktif Vaka Sayısı</h6>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <span class="mx-auto"
                                            style="color: white; font-size:15px; text-align:center "><strong>
                                                Tüm verilerin son güncellenme zamanı</strong>
                                            <span class="last-update">08.04.2021 10:05</span> </span>
                                    </div>
                                </div>
